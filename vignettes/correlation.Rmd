---
title: "Matrix Example - Correlation Matrices"
output: html_document
vignette: >
  %\VignetteIndexEntry{Matrix Example - Correlation Matrices}
...
```{r}
cor(mtcars) %>%
  hl_matrix(scale_colour_gradient2()) 
```
...
```{r}
cor(mtcars) %>%
  hl_matrix(scale_colour_gradient2(), selection = abs(.x) > 0.7) 
```
