...
* [Highlighting data.frames](https://coolbutuseless.github.io/package/emphatic/articles/intro.html)
* [Highlighting matrices](https://coolbutuseless.github.io/package/emphatic/articles/examples-matrices.html)
* [Highlighting vectors](https://coolbutuseless.github.io/package/emphatic/articles/examples-vectors.html)
...
sample(10, 30, replace = TRUE, prob = 1:10) %>%
  ...
  hl_vec('blue', .x > 7) %>%
  as_svg(600, 50) %>%
  cat(file = "man/figures/example5.svg")
```
